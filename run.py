...
def main():
    ...
    parser.add_argument('--dataset_size', type=str, default='sample_dataset', help='Which version/size of the dataset to use, options ["sample_dataset", "full_dataset"]')
    parser.add_argument('--dataset_features', type=str, default="all_features", help="how many features to use, options: [one_feature, subset_features, all_features]")
    parser.add_argument('--file_name', type=str, default='wind_data.csv', help='data file')
    parser.add_argument('--target', type=str, default='570715000000030505', help='optional target windmill (in form of a GSRN id) for non-graph models')
    ...
    parser.add_argument('--qk_ker', type=int, default=4, help='Key/Query convolxzution kernel length for LogSparse Transformer')
    ...
    parser.add_argument('--use_mps', type=bool, default=True, help="use MPS (Mac Silicon)")
    parser.add_argument('--mps', type=int, default=0, help="MPS (Mac Silicon)")
