...
from src.utils.masking import ProbMask, TriangularCausalMask, LogSparseMask


#Used in GraphFFTransformer
class FullAttention(nn.Module):
    def __init__(self, mask_flag: bool = True,
                 scale: ... = None,
...
class ProbAttention(nn.Module):
    ...
    def _update_context(self, context_in: ...,
                        V: ...,
                        scores: ...,
                        index: ...,
                        L_Q: ...
