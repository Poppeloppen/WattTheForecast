...
class EncoderLayer(nn.Module):
    def __init__(self, attention_fft:...,
                 attention_trend: ...,
                 d_model: int,
                 d_ff: ... = None,
                 dropout: float = 0.1,
        ...
        d_ff = d_ff or 4 * d_model #NOTE: beware - I think 4 is minutes, hours, days, weeks (in my case should be 3 - without minutes)
    ...
    def forward(self, x: ..., attn_mask:... = None, **kwargs: Any) -> ...:
        # FFT Attention
        x_freq, x_trend = x
...
class Encoder(nn.Module):
    def __init__(self, attn_layers: ...,
                 norm_freq: ... = None,
                 norm_trend: ... = None,
                 conv_layers_freq: ... = None,
                 conv_layers_trend: ... = None):
...
class DecoderLayer(nn.Module):
    def __init__(self, self_fft_attention: ...,
                 self_trend_attention: ...,
                 cross_fft_attention: ...,
                 cross_trend_attention: ...,
                 d_model: ...,
                 d_ff: ... = None, 
                 dropout: float = 0.1,
                 activation: str = "relu"
