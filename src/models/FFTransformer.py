...
from src.layers import FFTransformer_EncDec as FFT
from src.layers.FFT_SelfAttention import FFTAttention
from src.layers.SelfAttention_Family import LogSparseAttentionLayer, ProbAttention
from src.layers.Embed import DataEmbedding
from src.layers.WaveletTransform import get_wt
from src.layers.Functionality import MLPLayer


class Model(nn.Module):
    """
    FFTransformer Encoder-Decoder with Convolutional ProbSparse Attn for Trend and ProbSparse for Freq Stream
    """
